 ...
 * @author hoykj
 */
public class RabbitAlterTitle extends AbstractGameEffect {
    ...
    public void update(){
        ...
        this.gl.setText(LobotomyFontHelper.Font_118, this.word);
        this.x = Settings.WIDTH / 2.0F - this.gl.width - this.space;
        this.y = Settings.HEIGHT / 2.0F + this.gl.height / 2.0F;

        this.gl.setText(LobotomyFontHelper.Font_118, this.word2);
        this.x2 = Settings.WIDTH / 2.0F + this.space;
    }

    @Override
    public void render(SpriteBatch sb) {
        FontHelper.renderSmartText(sb, LobotomyFontHelper.Font_118, this.word, this.x, this.y, Settings.WIDTH, 0.0F, this.color);
        FontHelper.renderSmartText(sb, LobotomyFontHelper.Font_118, this.word2, this.x2, this.y, Settings.WIDTH, 0.0F, this.color);
    }
