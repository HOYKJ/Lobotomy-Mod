 ...
 * @author hoykj
 */
public class OrdealNameWord extends AbstractGameEffect {
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString("OrdealName");
    public static final String[] TEXT = uiStrings.TEXT;
    private GlyphLayout gl = new GlyphLayout();
    private String word;
    private float x, y;

    public OrdealNameWord(int code, int difficulty){
        this.duration = 6;
        ...
        this.word = TEXT[code * 4 + difficulty - 5];
    ...
    public void update(){
        ...
        this.gl.setText(LobotomyFontHelper.Font_38, this.word);
        this.x = Settings.WIDTH / 2.0F - this.gl.width / 2.0F;
        this.y = Settings.HEIGHT / 2.0F + 30.0F * Settings.scale + this.gl.height / 2.0F;
    }

    @Override
    public void render(SpriteBatch sb) {
        FontHelper.renderSmartText(sb, LobotomyFontHelper.Font_38, this.word, this.x, this.y, Settings.WIDTH, 0.0F, this.color);
    }
