 ...
 * @author hoykj
 */
public class BlackAttacker extends AbstractOrdealMonster {
    public static final String ID = "BlackAttacker";
    ...
    public BlackAttacker(float x, float y, int i) {
        super(NAME, "BlackAttacker", 1, 0.0F, 0.0F, 0.0F, 120.0F, null, x - (float) Settings.WIDTH * 0.75F / Settings.scale, y);
        loadAnimation("lobotomyMod/images/monsters/Ordeal/OutterGod/Midnight/tentacleB.atlas", "lobotomyMod/images/monsters/Ordeal/OutterGod/Midnight/tentacleB.json", 1.0F);
    ...
    public void update() {
        ...
        switch (this.code){
            ...
            case 1:
                ...
                this.drawY = AbstractDungeon.player.hb.cY + 390;
                break;
            case 2:
                this.drawX = AbstractDungeon.player.hb.cX + 450;
                this.drawY = AbstractDungeon.player.hb.cY + 390;
