 ...
 * @author hoykj
 */
public class LongArm extends AbstractMonster {
    public static final String ID = "LongArm";
    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings("LongArm");
    public static final String NAME = monsterStrings.NAME;
    public static final String[] MOVES = monsterStrings.MOVES;
    public static final String[] DIALOG = monsterStrings.DIALOG;
    private int counter;

    public LongArm(float x, float y) {
        super(NAME, "LongArm", 250, 0.0F, 0.0F, 160.0F, 200.0F, "lobotomyMod/images/monsters/ApocalypseBird/Egg/LongArm/LongArm.png", x, y);
    }
    ...
    public void damage(DamageInfo info) {
        ...
        if(this.currentHealth <= this.maxHealth / 2){
            this.img = ImageMaster.loadImage("lobotomyMod/images/monsters/ApocalypseBird/Egg/LongArm/LongArm_1.png");
        }
        if ((this.currentHealth <= 0) && (!this.halfDead)) {
            AbstractDungeon.topLevelEffects.add(new BlackForestStory(11));
            AbstractDungeon.topLevelEffects.add(new BlackForestStory(12));
            this.img = ImageMaster.loadImage("lobotomyMod/images/monsters/ApocalypseBird/Egg/LongArm/LongArm_2.png");
    ...
    public static class renderPatch {
        ...
        public static void prefix(AbstractMonster _inst, SpriteBatch sb){
            if((_inst instanceof LongArm) && (!_inst.isDead && !_inst.escaped)) {
                Settings.scale /= 3.0F;
            }
        }
