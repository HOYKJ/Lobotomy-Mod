 ...
 * @author hoykj
 */
public class GainStrengthPower2 extends AbstractPower {
    public static final String POWER_ID = "Shackled2";
    private static final PowerStrings powerStrings;
    public static final String NAME;
    public static final String[] DESCRIPTIONS;

    public GainStrengthPower2(AbstractCreature owner, int newAmount) {
        this.name = NAME;
        this.ID = "Shackled2";
        this.owner = owner;
