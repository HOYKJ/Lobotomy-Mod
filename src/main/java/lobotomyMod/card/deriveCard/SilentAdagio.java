 ...
 * @author hoykj
 */
public class SilentAdagio extends AbstractDeriveCard{
    public static final String ID = "SilentAdagio";
    private static final CardStrings cardStrings;
    public static final String NAME;
    public static final String DESCRIPTION;

    public SilentAdagio() {
        super("SilentAdagio", SilentAdagio.NAME, -2, SilentAdagio.DESCRIPTION, CardColor.COLORLESS, CardType.SKILL, CardTarget.NONE);
    ...
    public void triggerWhenDrawn() {
        ...
        AbstractDungeon.actionManager.addToTop(new silentMovementAction(2));
        ...
        AbstractDungeon.actionManager.addToBottom(new MakeTempCardInDiscardAction(new SilentScherzo(), 1));
    ...
    public AbstractCard makeCopy() {
        return new SilentAdagio();
    }

    static {
        cardStrings = CardCrawlGame.languagePack.getCardStrings("SilentAdagio");
        NAME = SilentAdagio.cardStrings.NAME;
        DESCRIPTION = SilentAdagio.cardStrings.DESCRIPTION;
    }
}
