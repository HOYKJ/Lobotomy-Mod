 ...
 * @author hoykj
 */
public class SilentScherzo extends AbstractDeriveCard{
    public static final String ID = "SilentScherzo";
    private static final CardStrings cardStrings;
    public static final String NAME;
    public static final String DESCRIPTION;

    public SilentScherzo() {
        super("SilentScherzo", SilentScherzo.NAME, -2, SilentScherzo.DESCRIPTION, CardColor.COLORLESS, CardType.SKILL, CardTarget.NONE);
    ...
    public void triggerWhenDrawn() {
        ...
        AbstractDungeon.actionManager.addToBottom(new MakeTempCardInDiscardAction(new SilentRondo(), 1));
    ...
    public AbstractCard makeCopy() {
        return new SilentScherzo();
    }

    static {
        cardStrings = CardCrawlGame.languagePack.getCardStrings("SilentScherzo");
        NAME = SilentScherzo.cardStrings.NAME;
        DESCRIPTION = SilentScherzo.cardStrings.DESCRIPTION;
    }
}
